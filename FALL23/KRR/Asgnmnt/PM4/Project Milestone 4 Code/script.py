...
while flag:
	out = subprocess.Popen(['clingo', 'main.asp', os.path.join('simpleInstances','inst'+str(instance_code)+'.asp'), '-c', 'n='+str(time)], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
